...
2)Mark as Done – Toggle tasks as completed with a tick.
...
5)UI – Soft colors, rounded buttons, and fun emojis for a playful vibe.
...
4)Add animations when tasks are completed.
